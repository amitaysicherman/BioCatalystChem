...
configs=" --dae 1  --prequantization 1 --ec_split 1 --n_hierarchical_clusters 0 --n_pca_components 5 --n_clusters_pca 5 |\
  ...
  --dae 1  --prequantization 1 --ec_split 1 --n_hierarchical_clusters 0 --n_pca_components 20 --n_clusters_pca 5 |\
  --dae 0  --prequantization 1 --ec_split 1 --n_hierarchical_clusters 0 --n_pca_components 20 --n_clusters_pca 5 |\
  ...
  --dae 1  --prequantization 1 --ec_split 1 --n_hierarchical_clusters 5 --n_pca_components 6 --n_clusters_pca 10 |\
  --dae 0  --prequantization 1 --ec_split 1 --n_hierarchical_clusters 5 --n_pca_components 6 --n_clusters_pca 10 |\
  ...
  --dae 1  --prequantization 1 --ec_split 1 --n_hierarchical_clusters 7 --n_pca_components 20 --n_clusters_pca 5 |\
  --dae 0  --prequantization 1 --ec_split 1 --n_hierarchical_clusters 7 --n_pca_components 20 --n_clusters_pca 5"
