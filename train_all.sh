...
configs="--dae 1 --ec_split 1 --lookup_len 5 --load_cp results_old/v4/regular/checkpoint-280000 --ecreact_only 1 --quantization 1 --q_groups 1 --q_codevectors 128|\
          ...
          --dae 1 --ec_split 1 --lookup_len 5 --load_cp results_old/v4/regular/checkpoint-280000 --ecreact_only 1 --quantization 1 --q_groups 1 --q_codevectors 128 --q_index 1|\
          --dae 1 --ec_split 1 --lookup_len 5 --load_cp results_old/v4/regular/checkpoint-280000 --ecreact_only 1 --quantization 1 --q_groups 4 --q_codevectors 128 --q_index 1|\
          --dae 1 --ec_split 1 --lookup_len 5 --load_cp results_old/v4/regular/checkpoint-280000 --ecreact_only 1 --quantization 1 --q_groups 1 --q_codevectors 1024 --q_index 1|\
          --dae 1 --ec_split 1 --lookup_len 5 --load_cp results_old/v4/regular/checkpoint-280000 --ecreact_only 1 --quantization 1 --q_groups 4 --q_codevectors 1024 --q_index 1"
